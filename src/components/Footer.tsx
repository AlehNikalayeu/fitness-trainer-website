        ...
        <footer className="footer">
            <div className="footer-content">
                ...
                <div className="footer-social">
                    <a href="https://www.facebook.com/anton.khadzko" target="_blank" rel="noopener noreferrer">
                        <FaSquareFacebook className="social-icon"/>Facebook
                    </a>
                    <a href="https://www.instagram.com/anton_khadzko" target="_blank" rel="noopener noreferrer">
                        <FaInstagram className="social-icon"/>Instagram
                    </a>
                    <a href="https://t.me/Antonkhadzko" target="_blank" rel="noopener noreferrer">
