            ...
            payload: [
                {
                    ...
                    text: "Anton is an amazing trainer! He helped me achieve my fitness goals and stay motivated.",
                    name: "Sergej Nalegach",
                },
                {
                    icon: "/images/feedbacks/IMG_6408.jpg",
                    text: "The training sessions with Anton are always challenging and rewarding. Highly recommend!",
                    name: "Viktoryia Babayeva",
                },
                {
                    icon: "/images/feedbacks/IMG_2002.jpg",
                    text: "With Anton's guidance, I've improved my performance and feel healthier than ever.",
                    name: "Kanstantin Sheleheda",
                },
                {
                    icon: "/images/feedbacks/0B4A6612.jpg",
                    text: "Anton's sessions are effective and engaging, helping me achieve my fitness goals and stay healthy.",
                    name: "Yuliana Utkina",
                },
            ],
        });
